...
if (!empty($_COOKIE["sesija"])) {
    ...
    if ($korisnik["tip"] == 2 || $korisnik["tip"] == 3) {
    ...
    <body>
        ...
        <section id="moderator">
            <fieldset id='prijava1'>
                ...
                <form method='post' name='moderira'>
                    <p>
                        <input class='kreiranje' type='button' id="kreirajNatjecanje" value="Organiziraj natjecanje">
                        <input class='kreiranje' type='button' id="kreirajVrstu" value="Kreiraj vrstu oglasa">
                        <input class='kreiranje' type='button' id="kreirajPitanje" value="Kreiraj novo pitanje">
                        <input class='kreiranje' type='button' id="postaviOglas" value="Postavi oglas">
                        <br>
                </form>
                <div id='forma'></div>
                </p>
